...
# Disabled on Windows: the plugin forks a child process to run the supervisor,
# and fork() is unimplemented on native Windows Ruby. Run `bin/jobs` separately instead.
